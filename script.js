function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="&#128140; Responde este mensaje."}}
  ...
  if(waktuSekarang < 10) {
      ...
      ucapan = "Buenas tardes, ";
  } else if(waktuSekarang < 19) {
      ucapan = "Buenas tardes, ";
  } else {
      ucapan = "Buenas noches, ";
  }
  ...
  function gantiopsL(){opsL.innerHTML="[ Haz clic en algunos ❤️ ]";opsL.style.opacity=".8";}
